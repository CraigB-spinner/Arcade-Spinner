...
3 - 3x12mm Countersunk Machine Head Screws (sourced from Traxxas hobby parts); cut to length with dremel; uses same Allen wrench as noted wheel.  
Lexan sheet 0.060" thick, size 95x53mm(3.75x2.1") or aluminum/steel sheet cut to same size of Sanwa JLF-P1 mounting plate. I don't recommend using joystick plate as holes are located at 90° and rotary encoder mounts at 120°. Clear Lexan makes visibility easier for fabrication.<br/><br/>
