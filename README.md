...
To construct this you will need a 2-phase rotary encoder which can operate at 5v and some momentary switch buttons plus micro controller.<br/> 
...
You will also need the Arduino joystick library available at: https://github.com/MHeironimus/ArduinoJoystickLibrary<br/><br/><br/>
...
Buttons 1-6, plus 9-select(coin), and 10-start(player) <br/><br/>
Pin |Button/wire
--- |-----------
2   |A spinner
3   |B spinner
